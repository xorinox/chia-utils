...
```
# loop over all directories and sub directories (one level down) and probe if the mount is of type NFS,
# before the probe, I print the mount first. Once the script hangs, we know which mount was probing..
